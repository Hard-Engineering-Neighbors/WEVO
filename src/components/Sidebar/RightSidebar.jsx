...
export default function RightSidebar({ onNotificationClick }) {
  ...
  return (
    <>
      {/* Floating Notification Summary (visible when collapsed) */}
      {isRightSidebarCollapsed && (
        <div className="hidden lg:flex fixed top-4 right-4 z-[60] items-center gap-2">
          <div className="relative bg-white shadow-lg border border-gray-200 rounded-full px-4 py-2 flex items-center gap-2">
            <Bell size={16} className="text-[#0458A9]" />
      ...
      {/* Toggle Button - Fixed on desktop */}
      <div
      ...
      >
        <button
          ...
          className="relative bg-[#0458A9] text-white p-2 rounded-l-lg shadow-lg hover:bg-[#03407a] transition-colors"
          title={
            isRightSidebarCollapsed
              ? "Show Notifications"
              : "Hide Notifications"
        ...
        >
          ...
          {/* Red Dot Notification Badge - Only show when collapsed and has unread */}
